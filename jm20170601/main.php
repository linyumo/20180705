...
$sql1 = "select * from jmmember001 where fathertwid001 = '$row[4]'";
$result1 = execute_sql1($link, "linyumo_wk01", $sql1);
if (mysqli_num_rows($result1) == 0){
    //釋放 $result 佔用的記憶體
    mysqli_free_result($result1);
  ...
  $rows1 = mysqli_num_rows($result1);
          echo "<td>$rows1<br><a style=text-decoration:none; href='mainf.php' target='_blank'>瀏覽清單</a></td>";
}

          echo "<td><a style=text-decoration:none; href='modify.php?editid001=$row[0]'>修改資料</a></td>";
          echo "<td><a style=text-decoration:none; href='modify.php?editid001=$row[0]'>預備功能</a></td>";
